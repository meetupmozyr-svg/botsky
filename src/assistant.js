...
- 🛡️ **Финансы и риски**: ДОБАВЛЯЙ ТОЛЬКО если вопрос касается отмен, перерывов, неявок, опозданий или оплаты. Если вопрос про поведение ученика, настройки компьютера или методику — ПРОПУСТИ этот блок полностью! (Напоминание: за сорванный по вине учителя урок всегда 0 ₽).
...
- 📚 **Ссылки на регламент**: ДОБАВЛЯЙ ТОЛЬКО если в данных из базы знаний выше есть статья, идеально совпадающая с вопросом. Если подходящих статей нет — ПРОПУСТИ этот блок, не выдумывай ссылки!`;
}
